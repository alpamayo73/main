...
export default function ContactHero() {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Get expert advice and quotes with no obligation or hidden costs"
    },
    {
      icon: (
        <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      text: "We guarantee to respond to all inquiries within 2 hours during business hours"
    }
  ]
