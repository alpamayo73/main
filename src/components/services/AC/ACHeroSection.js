...
const ACHeroSection = () => {
  ...
  const handleSecondaryClick = () => {
    ...
    console.log('Emergency AC Repair clicked');
  };
  ...
  return (
    <section style={styles.heroSection}>
      ...
      <div style={styles.content}>
        <h1 style={styles.title}>AIR CONDITIONING SERVICES</h1>
        <p style={styles.subtitle}>
          Professional AC Installation, Maintenance & Repair Services in Dubai. Stay Cool with Expert HVAC Solutions for Every Space
        </p>
