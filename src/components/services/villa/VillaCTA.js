// src/components/services/villa/VillaCTA.js
  ...
  return (
    <section style={styles.section}>
      <div style={styles.container}>
        <h2 style={styles.title}>Ready to Transform Your Villa?</h2>
        <p style={styles.text}>
          Let's discuss your vision for the perfect villa renovation in Dubai. 
          Get a free consultation and detailed quote from our expert team.
        </p>
