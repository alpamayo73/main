...
const ElectricalHeroSection = () => {
  ...
  const handleSecondaryClick = () => {
    ...
    console.log('Emergency Electrician clicked');
  };
  ...
  return (
    <section style={styles.heroSection}>
      ...
      <div style={styles.content}>
        <h1 style={styles.title}>PROFESSIONAL ELECTRICAL SERVICES</h1>
        <p style={styles.subtitle}>
          Certified Electrician Services in Dubai for Residential, Commercial, and Industrial Electrical Solutions. Safety First, Quality Always
        </p>
