// components/services/ContactCTA.js
  ...
  return (
    <section style={styles.section}>
      <div style={styles.container}>
        <h2 style={styles.title}>Ready to Start Your Project?</h2>
        <p style={styles.text}>
          Let's discuss how we can bring your vision to life with our premium renovation and AC services in Dubai.
        </p>
