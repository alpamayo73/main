// src/components/services/office/OfficeCTA.js
  ...
  return (
    <section style={styles.section}>
      <div style={styles.container}>
        <h2 style={styles.title}>Ready to Transform Your Workspace?</h2>
        <p style={styles.text}>
          Let's discuss your vision for a productive, inspiring office environment in Dubai. 
          Get a free consultation and workspace assessment from our expert team.
        </p>
        ...
        >
          Start Your Office Transformation
        </button>
        ...
        <div style={styles.contactInfo}>
          ...
          <div style={styles.contactItem}>
            <div style={styles.contactTitle}>Business Areas</div>
