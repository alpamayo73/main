    ...
    <section style={styles.section}>
      <div style={styles.container}>
        ...
        <p style={styles.description}>
          Contact Alpamayo Technical Services for professional tile installation in Dubai. 
          Get expert advice, premium materials, and flawless craftsmanship for your project.
        </p>
        ...
        <div style={styles.contactInfo}>
          <p style={styles.contactText}>For tile selection and design consultation</p>
          <a href="mailto:info@thealpamayo.com" style={styles.phone}>
            info@thealpamayo.com
          </a>
          <p style={styles.technicalNote}>
            Our tile experts provide free site assessments, material selection guidance, and detailed quotations
          </p>
        </div>
      </div>
    </section>
